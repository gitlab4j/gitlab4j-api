...
dependencies {
    ...
    implementation group: 'org.gitlab4j', name: 'gitlab4j-api', version: '6.2.0'
}
```
...
```java
//DEPS org.gitlab4j:gitlab4j-api:6.2.0
```
...
dependencies {
    ...
    implementation 'org.gitlab4j:gitlab4j-models:6.2.0'
}
```

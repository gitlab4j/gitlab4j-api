...
public class ExternalStatusCheckApi extends AbstractApi {
     ...
     * @throws GitLabApiException if any exception occurs
     */
    public Pager<ExternalStatusCheck> getExternalStatusChecks(Object projectIdOrPath, int itemsPerPage)
    ...
    public ExternalStatusCheck createExternalStatusCheck(
            Object projectIdOrPath, String name, String externalUrl, List<Long> protectedBranchIds)
            throws GitLabApiException {
     ...
     */
    public ExternalStatusCheck createExternalStatusCheck(
            Object projectIdOrPath, ExternalStatusCheck externalStatusCheck) throws GitLabApiException {
        List<Long> protectedBranchIds;
        if (externalStatusCheck.getProtectedBranches() == null) {
            protectedBranchIds = null;
        } else {
            protectedBranchIds = externalStatusCheck.getProtectedBranches().stream()
    ...
    public ExternalStatusCheck updateExternalStatusCheck(
            Object projectIdOrPath, Long checkId, String name, String externalUrl, List<Long> protectedBranchIds)
            throws GitLabApiException {
        Form formData = new GitLabApiForm()
                .withParam("name", name)
     ...
     * @throws GitLabApiException if any exception occurs
     */
    public List<ExternalStatusCheckStatus> getExternalStatusCheckStatuses(Object projectIdOrPath, Long mergeRequestIid)
            throws GitLabApiException {
    ...
    public Stream<ExternalStatusCheckStatus> getExternalStatusCheckStatusesStream(
            Object projectIdOrPath, Long mergeRequestIid) throws GitLabApiException {
    ...
    public ExternalStatusCheckResult setStatusOfExternalStatusCheck(
            Object projectIdOrPath, Long mergeRequestIid, String sha, Long externalStatusCheckId, Status status)
            throws GitLabApiException {
        Form formData = new GitLabApiForm()
                .withParam("sha", sha)
